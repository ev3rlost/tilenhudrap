        ...
        <div class="relative w-full md:w-1/2 h-full flex items-center">
            ...
            <div class="z-10 w-full h-full flex flex-col gap-8 justify-center items-center">
                ...
                <div class="flex gap-8 mt-2">
                    <a wire:navigate href="{{ route('biography') }}" class="text-left md:text-center text-xs md:text-base shadow-md bg-none border-2 border-neutral-500 text-white font-semibold uppercase tracking-widest p-2 md:p-4 rounded hover:bg-brand/20 hover:ring-2 hover:ring-brand hover:border-transparent transition">learn more ...</a>
                    <a wire:navigate href="{{ route('contact') }}" class="text-left md:text-center text-xs md:text-base shadow-md bg-none border-2 border-neutral-500 text-white font-semibold uppercase tracking-widest p-2 md:p-4 rounded hover:bg-brand/20 hover:ring-2 hover:ring-brand hover:border-transparent transition">Get in touch!</a>
                </div>
            </div>
    ...
    <div class="mb-8">
        <div class="bg-black/40 p-4 md:p-8 rounded-xl flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-2/3 text-neutral-400 text-sm md:text-base">
                <div class="text-brand mb-4">03/08/2022</div>
